...
/**
 * Cover / Intro Panel — terracotta brand panel + white form card.
 */
    ...
    <>
      <aside className="hidden w-[42%] shrink-0 flex-col justify-between bg-terracotta p-8 md:flex lg:p-12">
        ...
        <div>
          ...
          <p className="mt-3 text-body text-white/80">
            Pick up your courses, quizzes, and AI tutor where you left off.
          </p>
          <ul className="mt-8 flex flex-col gap-4">
            {[
              { icon: Sparkles, text: "AI courses from any PDF" },
              { icon: BookOpenText, text: "Lessons with quizzes" },
              { icon: MessageCircle, text: "RAG tutor that knows your progress" },
            ].map(({ icon: Icon, text }) => (
      ...
      <div className="flex flex-1 flex-col justify-center px-5 py-10 md:px-12 lg:px-20">
        <div className="mx-auto w-full max-w-md rounded-card-lg bg-white p-6 shadow-card md:p-8">
          ...
          <h2 className="text-section text-heading">Log in</h2>
